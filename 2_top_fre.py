...
def lab_templates(top_fre = None, least_num = None, img_add = new_img_add, lab_add = lab_add, mode_list = mode_list, templates_path = templates_path):
